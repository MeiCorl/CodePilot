...
│   │   │   ├── builtin/                 #   内置 Skill 目录（本步骤为空，预留扩展）
│   │   │   │   └── README.md            #     占位说明
...
| 来源级别  | 路径                                              | 优先级 | 典型场景                                |
| ----- | ----------------------------------------------- | --- | ----------------------------------- |
| 内置级   | `<exec>/internal/skill/builtin/<name>/SKILL.md` | 最低  | CodePilot 官方预留扩展（本步骤为空）                |
...
> 当前最新版本 **V1.6.0** · 最近更新 **2026-06-24** · 进行中 **—**（10/12 主线步骤完成，下一步 Step 11 Hook 系统）
> 详细进度见 [.harness/PROGRESS.md](.harness/PROGRESS.md)

```
[██████████████████████████████████░░░] 10/12 主线步骤完成（Step 1-8 已完成 + Step 9/9.1 快捷命令系统已落地 + Step 10 Skill 系统已落地，Step 11-12 待开始）
